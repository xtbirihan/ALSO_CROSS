*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_LGTYP_ALGO
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_LGTYP_ALGO      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_LGTYP_ALGO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_LGTYP_ALGO_EXTRACT
TOTAL = ZMV_LGTYP_ALGO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_LGTYP_ALGO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_LGTYP_ALGO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_LGTYP_ALGO_EXTRACT
TOTAL = ZMV_LGTYP_ALGO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_LGTYP_ALGO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_LGTYP_ALGO'
...
TOTAL = ZMV_LGTYP_ALGO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_LGTYP_ALGO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_LGTYP_ALGO-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_LGTYP_ALGO'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_LGTYP_ALGO-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_LGTYP_ALGO_EXTRACT
TOTAL = ZMV_LGTYP_ALGO_TOTAL
