...
CLASS lcx_no_material DEFINITION INHERITING FROM cx_static_check ##CLASS_FINAL.

ENDCLASS.

CLASS lcx_not_qualified DEFINITION INHERITING FROM cx_static_check ##NEEDED ##CLASS_FINAL.

ENDCLASS.

CLASS lcx_interface_incorrect DEFINITION INHERITING FROM cx_static_check ##NEEDED ##CLASS_FINAL.

ENDCLASS.

CLASS lcx_data_not_found DEFINITION INHERITING FROM cx_static_check ##NEEDED ##CLASS_FINAL.

ENDCLASS.

CLASS lcx_text_not_found DEFINITION FINAL INHERITING FROM cx_static_check ##NEEDED ##CLASS_FINAL.
