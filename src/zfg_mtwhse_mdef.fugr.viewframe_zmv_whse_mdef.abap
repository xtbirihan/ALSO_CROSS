*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_WHSE_MDEF
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_WHSE_MDEF       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_WHSE_MDEF'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_WHSE_MDEF_EXTRACT
TOTAL = ZMV_WHSE_MDEF_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_WHSE_MDEF'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_WHSE_MDEF-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WHSE_MDEF_EXTRACT
TOTAL = ZMV_WHSE_MDEF_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_WHSE_MDEF-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_WHSE_MDEF'
...
TOTAL = ZMV_WHSE_MDEF_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_WHSE_MDEF-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_WHSE_MDEF-UPD_FLAG NE SPACE.
