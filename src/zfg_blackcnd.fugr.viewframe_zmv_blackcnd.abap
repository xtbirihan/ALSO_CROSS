*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_BLACKCND
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_BLACKCND        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_BLACKCND'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_BLACKCND_EXTRACT
TOTAL = ZMV_BLACKCND_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_BLACKCND'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_BLACKCND-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_BLACKCND_EXTRACT
TOTAL = ZMV_BLACKCND_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_BLACKCND-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_BLACKCND'
...
TOTAL = ZMV_BLACKCND_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_BLACKCND-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_BLACKCND-UPD_FLAG NE SPACE.
