*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_TEXTS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_TEXTS           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_TEXTS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_TEXTS_EXTRACT
TOTAL = ZMV_TEXTS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_TEXTS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_TEXTS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_TEXTS_EXTRACT
TOTAL = ZMV_TEXTS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_TEXTS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_TEXTS'
...
TOTAL = ZMV_TEXTS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_TEXTS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_TEXTS-UPD_FLAG NE SPACE.
