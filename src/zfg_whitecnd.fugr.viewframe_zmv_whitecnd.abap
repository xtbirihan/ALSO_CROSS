*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_WHITECND
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_WHITECND        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_WHITECND'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_WHITECND_EXTRACT
TOTAL = ZMV_WHITECND_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_WHITECND'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_WHITECND-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WHITECND_EXTRACT
TOTAL = ZMV_WHITECND_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_WHITECND-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_WHITECND'
...
TOTAL = ZMV_WHITECND_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_WHITECND-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_WHITECND-UPD_FLAG NE SPACE.
